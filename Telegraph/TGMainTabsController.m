...
- (instancetype)initWithFrame:(CGRect)frame presentation:(TGPresentation *)presentation
{
    ...
    if (self != nil)
    {
        ...
        _stripeView.backgroundColor = [TGPresentation classicIOS6Style] ? UIColorRGB(0xa4a8ac) : presentation.pallete.barSeparatorColor;
...
- (void)setPresentation:(TGPresentation *)presentation
{
    ...
    [_contactsButton setClassicSelectedImage:[TGPresentation classicIOS6Style] ? TGMainTabsClassicIOS6Image(@"TabIconContacts_Highlighted") : nil];
    [_chatsButton setClassicSelectedImage:[TGPresentation classicIOS6Style] ? TGMainTabsClassicIOS6Image(@"TabIconMessages_Highlighted") : nil];
    [_settingsButton setClassicSelectedImage:[TGPresentation classicIOS6Style] ? TGMainTabsClassicIOS6Image(@"TabIconSettings_Highlighted") : nil];
