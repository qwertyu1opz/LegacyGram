# Tele6ram Theos application package

This is a Theos application port scaffold for the cleaned source tree. It
packages `/Applications/Tele6ram.app` into a rootful iOS 6 `.deb`; it does not
...
1. Install Theos and an iOS 6-compatible SDK/toolchain, then set `THEOS` if it
   ...
   this tree in a directory such as `~/Tele6ram_Public`, not `Tele6ram_Public 2`.
